...
/**
* respect to https://github.com/daipeng7/postcss-plugin-px2rem/
**/
...
module.exports = postcss.plugin('postcss-plugin-px2rem', function (options) {
  ...
  return function (css) {
    css.walkDecls(function (decl, i) {
      ...
      if (opts.includes && opts.includes.length && css.source.input.file) {
        var match = false;
        for (var _i = 0, len = opts.includes.length; _i < len; _i++) {
          var ele = opts.includes[_i];
          if (css.source.input.file.match(ele) !== null) {
            match = true;
            break;
          }
        }
